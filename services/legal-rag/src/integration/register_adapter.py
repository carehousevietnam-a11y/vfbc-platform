"""REGISTER workflow adapter for STEP12."""
...
def build_register_bundle(
    *,
    ...
    if context.service_group != "register":
        raise ValueError("REGISTER adapter requires service_group='register'")
    ...
    return IntegratedReportBundle("register", context, tuple(deliveries))
