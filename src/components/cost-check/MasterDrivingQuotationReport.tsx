            ...
            <div className="flex-1 space-y-4 px-3.5 py-3.5 sm:space-y-4 sm:px-4 sm:py-3.5">
              <section aria-labelledby="driving-cost-summary">
                  ...
                  <li className="rounded-[6px] border border-[#D8DEE8] bg-white px-3 py-2.5">
                    ...
                    <dl className="mt-2 grid grid-cols-2 gap-x-3 gap-y-1.5 border-t border-[#EEF2F7] pt-2">
                      <div>
                        ...
                        <dd className="mt-0.5 break-keep text-[12.5px] font-bold tabular-nums leading-snug text-[#0B2A6B]">
                  ...
                  <li className="rounded-[6px] border border-[#D8DEE8] bg-white px-3 py-2.5">
                    ...
                    <dl className="mt-2 grid grid-cols-2 gap-x-3 gap-y-1.5 border-t border-[#EEF2F7] pt-2">
                      <div className="col-span-2 min-w-0">
                        <dt className="text-[10px] font-medium text-[#94A3B8]">금액 (VND)</dt>
                        <dd className="mt-0.5 break-keep text-[12.5px] font-semibold leading-snug text-[#0B2A6B]">
                          {marketDisplay}
                        </dd>
                      </div>
                      <div>
                ...
                {!hasQuote ? (
                  <div className="mt-3 border-t border-[#D8DEE8] pt-2.5 sm:mt-2.5">
                    ...
                    <CheckMarketCaseRefs cases={DRIVING_CHECK_MARKET_CASES} className="mt-1.5" />
                  </div>
                ) : null}
              </section>
              ...
              {hasQuote && grade ? (
                <section aria-labelledby="driving-cost-analysis">
                  <SectionTitle id="driving-cost-analysis" number="2" title="비용 분석 결과" />
              ...
              <section aria-labelledby="driving-extra-costs">
                <SectionTitle id="driving-extra-costs" number="3" title="추가 발생 가능 비용" />
                <p className="mb-2 max-w-[40rem] break-keep text-[12.5px] leading-[1.65] text-[#475569] sm:mb-1.5 sm:text-[13px]">
