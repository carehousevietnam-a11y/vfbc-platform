            ...
            <div className="flex-1 space-y-4 px-3.5 py-3.5 sm:space-y-4 sm:px-4 sm:py-3.5">
              <section aria-labelledby="wp-cost-summary">
                ...
                {!hasQuote ? (
                  <div className="mt-3 border-t border-[#D8DEE8] pt-2.5 sm:mt-2.5">
                    ...
                    <CheckMarketCaseRefs cases={WP_CHECK_MARKET_CASES} className="mt-1.5" />
                  </div>
                ) : null}
              </section>
              ...
              {hasQuote && grade ? (
                <section aria-labelledby="wp-cost-analysis">
                  <SectionTitle id="wp-cost-analysis" number="2" title="비용 분석 결과" />
              ...
              <section aria-labelledby="wp-extra-costs">
                <SectionTitle id="wp-extra-costs" number="3" title="추가 발생 가능 비용" />
                <p className="mb-2 max-w-[40rem] break-keep text-[12.5px] leading-[1.65] text-[#475569] sm:mb-1.5 sm:text-[13px]">
