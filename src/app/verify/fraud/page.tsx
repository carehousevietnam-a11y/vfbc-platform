...
import { ArrowLeft, ShieldAlert, CheckCircle2, Paperclip, AlertTriangle, Info } from "lucide-react";
      ...
      <div className="mx-auto max-w-xl px-6 py-10">
        ...
        {step === "form" && (
          <div className="mt-8 rounded-3xl bg-white border border-gray-100 p-7 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
            ...
            <p className="mt-4 text-sm text-gray-600 leading-relaxed">
              ...
              어렵습니다. 서명하거나 입금하기 전에 사기 패턴부터 먼저
              확인하세요. 서류 사진이나 PDF·워드 파일을 첨부하고
        ...
        {step === "diagnosis" && diagnosis && (
          <div className="mt-8 rounded-3xl bg-white border border-red-100 p-7 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
            ...
            <div className="mt-5 rounded-xl bg-red-50 px-4 py-3 text-xs text-red-800 leading-relaxed">
              간단한 내용은 무료 1차 상담으로도 확인 가능합니다. 위 항목
              중 하나라도 해당된다면, 실제 송금 전에 반드시 전문가가
              직접 확인해드립니다.
            </div>
            ...
            <button
              ...
              className="mt-4 w-full h-12 rounded-full bg-red-600 text-sm font-semibold text-white hover:bg-red-700 disabled:opacity-60 transition-colors"
            >
