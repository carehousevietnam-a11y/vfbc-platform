...
import { ArrowLeft, HelpCircle, CheckCircle2, Paperclip } from "lucide-react";
...
export default function VerifyUnclearPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (file && file.size > 0) {
      ...
      const path = `verify-unclear/${leadId}.${safeExt}`;
          ...
          {!submitted ? (
            <>
              <p className="mt-4 text-sm text-gray-600 leading-relaxed">
                ...
                오히려 더 위험해질 수 있습니다. 무슨 서류인지부터 먼저
                알아보세요. 서류 사진이나 PDF·워드 파일을 첨부하고
            ...
            <div className="mt-5">
              ...
              <Link href="/consultation?case=verify-unclear"
