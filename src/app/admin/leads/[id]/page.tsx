  ...
  if (!stageInsertError) {
    ...
    if (savedPath) {
      try {
        ...
        console.error("[admin/leads] permit Signed URL for notify failed:", signedCatchErr);
      }
  ...
  let permitFileUrl: string | null = null;
  {
    ...
    if (storagePath) {
      try {
        ...
        console.error("[admin/leads/id] permit Signed URL failed:", err);
      }
    } else if (legacyUrl) {
  ...
  let fileUrl: string | null = null;
  {
    ...
    if (storagePath) {
      try {
        ...
        console.error("[admin/leads/id] verify attachment Signed URL failed:", err);
      }
    } else if (legacyUrl) {
      fileUrl = legacyUrl;
    }
