          ...
          <div className="mt-4 grid min-w-0 gap-3.5 lg:grid-cols-[minmax(0,2.05fr)_minmax(320px,0.95fr)] lg:items-start">
            <div className="min-w-0 space-y-3.5">
              <section className="min-w-0 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_1px_3px_rgba(15,23,42,0.08)]">
                <div className="flex flex-col gap-3 border-b border-blue-100 bg-blue-50/60 px-5 py-2.5 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    <h2 className="text-[17px] font-extrabold">고객 제출 문서</h2>
                  ...
                  <span className="inline-flex w-fit items-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 text-[11px] font-semibold text-slate-700 shadow-[0_1px_3px_rgba(15,23,42,0.08)]">
                ...
                <div className="hidden overflow-x-auto sm:block">
                  <table className="w-full min-w-[760px] text-left text-[13px]">
                    <thead className="sticky top-0 z-10 border-b border-slate-100 bg-slate-50 text-slate-500">
                      <tr>
                        <th className="px-5 py-2.5 font-bold">문서명</th>
                        <th className="px-3 py-2.5 font-bold">파일명</th>
                        <th className="px-3 py-2.5 font-bold">구분</th>
                        <th className="px-3 py-2.5 font-bold">제출일</th>
                      ...
                      {requiredDocuments.map((label, index) => {
                        ...
                        return (
                          <tr key={label} className="transition-colors odd:bg-white even:bg-slate-50/40 hover:bg-blue-50/50">
                            ...
                            <td className="px-3 py-2.5 font-medium text-slate-600">{displayFileName}</td>
                            ...
                            <td className="px-3 py-2.5 text-slate-500">{displayDate}</td>
                            <td className="px-3 py-2.5">
                            ...
                            <td className="px-3 py-2.5 text-center">
                              {canOpen ? (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="inline-flex min-w-[52px] items-center justify-center rounded-md border border-slate-200 bg-white px-3 py-1.5 font-bold text-slate-700 shadow-[0_1px_3px_rgba(15,23,42,0.08)] hover:border-blue-300 hover:text-blue-700"
                                >
                                  열기
                                </a>
                              ) : (
                ...
                <div className="divide-y divide-slate-100 sm:hidden">
                  {requiredDocuments.map((label, index) => {
                    ...
                    return (
                      <div key={label} className="flex w-full items-center gap-3 px-5 py-2.5">
              ...
              <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_1px_3px_rgba(15,23,42,0.08)] sm:p-6">
                <div className="flex flex-wrap items-center gap-2">
                  <h2 className="text-[17px] font-extrabold">AI 진단 결과</h2>
