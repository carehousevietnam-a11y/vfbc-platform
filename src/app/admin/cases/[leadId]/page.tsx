  ...
  return (
    <main className="min-h-screen bg-[#f4f7fb] text-slate-900">
      ...
      <div className="w-full xl:pl-[204px]">
        <div className="mx-auto w-full max-w-[1180px] px-4 py-5 sm:px-5 lg:px-5 lg:py-5">
          ...
          <div className="mt-4 grid min-w-0 gap-4 lg:grid-cols-[minmax(0,1.65fr)_minmax(280px,0.95fr)] lg:items-start">
