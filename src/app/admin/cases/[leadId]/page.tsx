    ...
    <main className="min-h-screen bg-[#f4f7fb] text-slate-900">
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[204px] flex-col bg-[#102b4e] text-white xl:flex">
        ...
        <nav className="flex-1 space-y-1 px-3 py-5 text-[13px]">
          ...
          <div className="rounded-xl bg-white/10 p-1"><div className="flex items-center justify-between rounded-lg bg-white/10 px-3 py-2.5 font-semibold"><span className="flex items-center gap-3"><Inbox size={16}/>신청건 관리</span><ChevronDown size={14}/></div><div className="ml-5 mt-1 border-l border-white/15 py-1 pl-3 text-white/70"><Link href="/admin/cases" className="block rounded-md bg-white/10 px-3 py-2 font-semibold text-white">전체 신청건</Link><span className="block px-3 py-2">미확인 문서</span><span className="block px-3 py-2">보완 요청</span><span className="block px-3 py-2">긴급 건</span></div></div>
          <div className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-white/70"><FolderOpen size={16}/>문서 관리</div><div className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-white/70"><Users size={16}/>직원 관리</div><div className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-white/70"><BarChart3 size={16}/>통계 및 리포트</div><div className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-white/70"><Settings size={16}/>설정</div>
        </nav><div className="border-t border-white/10 p-4 text-[13px] text-white/70"><div className="flex items-center gap-3 rounded-lg px-3 py-2.5"><LogOut size={16}/>로그아웃</div></div>
      </aside>
