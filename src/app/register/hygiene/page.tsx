  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <div className={`mx-auto px-6 py-10 ${resultScreenActive ? "max-w-4xl" : "max-w-xl"}`}>
        ...
        {rejectionStepDone && !hygieneChoice && (
          <div className="mt-8">
        ...
        {/* 질문 3 — 사업자·법인 등록 서류 준비 (모바일 2열 유지 — Hygiene 확정 요구사항) */}
        {rejectionStepDone && hygieneChoice && !isUnlicensedOperating && !registrationStatus && (
          <div className="mt-8">
        ...
        {rejectionStepDone && registrationStatus && !facilityStatus && (
          <div className="mt-8">
            <QuestionSection step={4} title="위생시설을 갖추셨나요?">
              <div className="grid grid-cols-2 gap-3">
        ...
        {rejectionStepDone && registrationStatus && facilityStatus && !staffHygieneStatus && (
          <div className="mt-8">
            <QuestionSection step={5} title="종사자 건강검진과 위생교육 준비를 마치셨나요?">
              <div className="grid grid-cols-2 gap-3">
