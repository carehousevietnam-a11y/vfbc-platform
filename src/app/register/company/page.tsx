  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <div className="mx-auto max-w-xl px-6 py-10">
        ...
        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900">법인설립</h1>
        <p className="mt-1 text-sm text-gray-500">IRC·ERC 포함 설립 절차</p>
        ...
        <div className="mt-8 rounded-3xl bg-white border border-gray-100 p-7 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
          ...
          {!submitted ? (
            ...
            <div className="mt-5">
              ...
              <Link href="/consultation?case=register-company"
