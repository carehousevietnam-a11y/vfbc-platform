  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <div className={`mx-auto px-6 py-10 ${resultScreenActive ? "max-w-4xl" : "max-w-xl"}`}>
        ...
        {rejectionStepDone && !distributionChoice && (
          <div className="mt-8">
            <QuestionSection step={2} title="현재 화장품을 어떻게 유통하고 계신가요?">
        ...
        {/* 질문 3 — 사업자·법인 등록 서류 준비 (모바일 2열 유지 — Cosmetics 확정 요구사항) */}
        {rejectionStepDone && distributionChoice && !isUnlicensedDistributing && !registrationStatus && (
          <div className="mt-8">
            <QuestionSection step={3} title="사업자·법인(수입/유통업자) 등록 서류가 준비되어 있나요?">
              <div className="grid grid-cols-2 gap-3">
        ...
        {rejectionStepDone && registrationStatus && !facilityStatus && (
          <div className="mt-8">
            <QuestionSection step={4} title="제조·유통·보관 시설(창고)을 확보하셨나요?">
              <div className="grid grid-cols-2 gap-3">
        ...
        {rejectionStepDone && registrationStatus && facilityStatus && !safetyDataStatus && (
          <div className="mt-8">
            <QuestionSection step={5} title="제품 성분·안전성 평가자료를 준비하셨나요?">
              <div className="grid grid-cols-2 gap-3">
