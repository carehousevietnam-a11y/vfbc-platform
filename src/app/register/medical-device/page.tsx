  ...
  return (
    ...
    >
      ...
      />
        ...
        {costEntryDone && rejectionStepDone && !medicalDeviceChoice && (
          <div className="mt-4 sm:mt-5">
            <VerifyStepLayout
              engine="register"
              step={2}
        ...
        {costEntryDone && rejectionStepDone && medicalDeviceChoice && !isUnlicensedOperating && !registrationStatus && (
          <div className="mt-4 sm:mt-5">
            <VerifyStepLayout
              engine="register"
              step={3}
        ...
        {costEntryDone && rejectionStepDone && registrationStatus && facilityStatus && !qualityDocStatus && (
          <div className="mt-4 sm:mt-5">
            <VerifyStepLayout
              engine="register"
              step={4}
