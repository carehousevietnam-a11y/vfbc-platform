  ...
  return (
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <div className="mx-auto max-w-xl px-6 py-10">
        ...
        <h1 className="mt-2 text-2xl font-bold tracking-tight text-gray-900">의료기기허가</h1>
        <p className="mt-1 text-sm text-gray-500">의료기기 수입·유통 허가</p>

        <div className="mt-8 rounded-3xl bg-white border border-gray-100 p-7 shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
          <Stethoscope className="text-amber-700" size={28} />
          ...
          {!submitted ? (
            ...
            <div className="mt-5">
              ...
              <Link href="/consultation?case=register-medical-device"
