    ...
    <main className="min-h-screen bg-[#fafafa]">
      ...
      <div className={`mx-auto px-6 py-10 ${resultScreenActive ? "max-w-4xl" : "max-w-xl"}`}>
        ...
        {rejectionStepDone && !medicalDeviceChoice && (
          <div className="mt-8">
            <QuestionSection step={2} title="현재 의료기기를 어떻게 수입·유통하고 계신가요?">
        ...
        {/* 질문 3 — 사업자·법인 등록 서류 준비 (모바일 2열 유지 — MedicalDevice 확정 요구사항) */}
        {rejectionStepDone && medicalDeviceChoice && !isUnlicensedOperating && !registrationStatus && (
          <div className="mt-8">
        ...
        {rejectionStepDone && registrationStatus && !facilityStatus && (
          <div className="mt-8">
            <QuestionSection step={4} title="보관·유통시설(창고)을 확보하셨나요?">
              <div className="grid grid-cols-2 gap-3">
        ...
        {rejectionStepDone && registrationStatus && facilityStatus && !qualityDocStatus && (
          <div className="mt-8">
            <QuestionSection step={5} title="제품 분류와 품질서류를 준비하셨나요?">
              <div className="grid grid-cols-2 gap-3">
