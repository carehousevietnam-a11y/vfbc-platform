  ...
  return (
    ...
    >
      ...
      />
        ...
        {costEntryDone && rejectionStepDone && !fireSafetyChoice && (
          <div className="mt-4 sm:mt-5">
            <VerifyStepLayout
              engine="register"
              step={2}
        ...
        {costEntryDone && rejectionStepDone && fireSafetyChoice && !isUnlicensedOperating && !registrationStatus && (
          <div className="mt-4 sm:mt-5">
            <VerifyStepLayout
              engine="register"
              step={3}
        ...
        {costEntryDone && rejectionStepDone && registrationStatus && facilityStatus && !safetyManagerStatus && (
          <div className="mt-4 sm:mt-5">
            <VerifyStepLayout
              engine="register"
              step={4}
